...
//        с названием, равным фамилии, в него в одну строку должны записаться
...
public class Main {
    ...
    // ivanov,ivan,ivanovich 12.12.2000 123456789 m

    public static void main (String[] args) throws Exception {
        new ControllerProgram ().checkingDataReceivedFromTheUser (
                new UserUI ().start ());
    }
}
